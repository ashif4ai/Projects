...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true && isset($_SESSION["user_admin"])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "INSERT INTO `admin` (`userType`, `admin_username`, `adminName`, `admin_email`,`admin_pin`,`registeredOn`) VALUES ('$userType','$admin_email','$adminName','$admin_email','$admin_pin','$Date')";
...
<body>
    <div class="main">
        ...
        <h1 class="header-primary">Admin Registration</h1>
        <div class="disc">Fill the form to register as admin</div>
